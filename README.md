...
**Topics Covered**:
- The LLM coding revolution and its impact on software engineering
- Code as the language of computers: LLMs as bridge between intention and execution
- Understanding AI agents: "LLM + tools in a loop"
- Three levels of coding with LLMs:
  - Level 1: "Vibe Coding" (chat window coding)
  - Level 2: IDE Integration (Cursor, VS Code, GitHub Copilot)
  - Level 3: Advanced Agentic Coding (Claude Code, Codex)
- Best practices and techniques for effective LLM coding
- Mental shift from writing code to software architect
...
#### Level 1: "Vibe Coding" - G7 GDP Visualization (Slide 10)
Demonstrates the simplest entry point for coding with LLMs: prompting the model to generate code in a chat window, then copying and running it locally.

**Task**: Write code in Python to plot real GDP per capita for all G7 countries from 2010 to 2025, normalized so 2010=100.

| # | Description | Files |
|---|-------------|-------|
| 1 | Python script generated by Gemini to fetch G7 GDP data from World Bank API and create visualizations | [plot_GDP_Gemini.py](./examples/workshop5/plot_GDP_Gemini.py?raw=1) |
| 2 | Generated output: Two charts showing GDP growth (per capita and total) for G7 countries, normalized to 2010=100 | [G7_GDP_plots.png](./examples/workshop5/G7_GDP_plots.png?raw=1) |
